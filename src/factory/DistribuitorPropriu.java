...
public class DistribuitorPropriu implements IDistribuitor{
	private String nume;
	private String IBAN;
	private ArrayList<Comanda> listaComenzi;
	
	public DistribuitorPropriu(String nume, String iBAN) {
		super();
		this.nume = nume;
		IBAN = iBAN;
	...
	public void info() {
		...
		System.out.println("Distribuitor propriu cu numele " + this.nume + " avand IBAN=" + this.IBAN + ".Contine " + listaComenzi.size() + " comenzi!");
